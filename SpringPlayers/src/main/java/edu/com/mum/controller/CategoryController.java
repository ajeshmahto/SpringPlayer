...
class CategoryController {
	...
	/*
	 * @ModelAttribute("categories") private List<Category> getCategories(Model
	 * model) { //model.addAttribute("categories", new Category()); return
	 * categoryService.findAll(); }
	 */
	...
	public String getProductByCategoryId(Model model, @PathVariable("id") long id, HttpServletRequest request) {
